  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    if (!hasPowerup) {
      if(other is Rocket){
        ...
        switch (current) {
        case PlayerState.center : current =  PlayerState.nooglerCenter;
 break;
        case PlayerState.left : current =  PlayerState.nooglerLeft;
 break;
        case PlayerState.right : current =  PlayerState.nooglerRight;
        };
        other.removeFromParent();
      ...
      //      case PlayerState.center : return PlayerState.nooglerCenter,
